        ...
        If ws.Cells(i + 1, 1).Value <> ws.Cells(i, 1).Value Then
            ...
            Open_Price = ws.Cells(i + 1, 3).Value
                ...
                Else
                   ...
                   ws.Range("K" & Summary_Total).Value = ((Open_Price - Close_Price) / Open_Price) * 100
            ...
            ws.Range("L" & Summary_Total).Value = Volume_Total
                ...
                If ws.Range("K" & Summary_Total).Value > 0 Then
                        
                    ws.Range("K" & Summary_Total).Interior.Color = vbGreen
                        
                Else
                    
                    ws.Range("K" & Summary_Total).Interior.Color = vbRed
